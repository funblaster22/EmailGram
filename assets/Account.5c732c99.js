import{S as p,i as f,s as y,g as b,e as o,j as h,a as u,n as m,d,F as v,D as c}from"./index.7c0ff3be.js";import{u as g,h as _,c as k}from"./gapi.e7450da9.js";function S(n){let e,l,i;return{c(){e=o("button"),e.textContent="Sign in"},m(a,s){u(a,e,s),l||(i=c(e,"click",_),l=!0)},p:m,d(a){a&&d(e),l=!1,i()}}}function w(n){let e,l,i;return{c(){e=o("button"),e.textContent="Sign out"},m(a,s){u(a,e,s),l||(i=c(e,"click",k),l=!0)},p:m,d(a){a&&d(e),l=!1,i()}}}function z(n){let e,l;function i(t,r){return t[0]?w:S}let a=i(n),s=a(n);return{c(){s.c(),e=b(),l=o("div"),l.innerHTML=`<div class="settingGroup svelte-henz6m">Messages
    ...
    <div class="settingGroup svelte-henz6m">Help
        ...
        <details><summary class="svelte-henz6m">\u{1F4D6} Legal</summary>
            hidden</details></div>`,h(l,"class","px-6 py-2")},m(t,r){s.m(t,r),u(t,e,r),u(t,l,r)},p(t,[r]){a===(a=i(t))&&s?s.p(t,r):(s.d(1),s=a(t),s&&(s.c(),s.m(e.parentNode,e)))},i:m,o:m,d(t){s.d(t),t&&d(e),t&&d(l)}}}function x(n,e,l){let i;return v(n,g,a=>l(0,i=a)),[i]}class E extends p{constructor(e){super(),f(this,e,x,z,y,{})}}export{E as default};
